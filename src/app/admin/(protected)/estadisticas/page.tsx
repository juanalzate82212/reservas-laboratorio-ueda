...
import { LineaMensual, type PuntoMensual } from "@/components/admin/charts/LineaMensual";
...
export default function AdminEstadisticasPage() {
  ...
  const sinNadaQueMostrar = !cargando && datos !== null && datos.totales.solicitadas === 0;

  return (
    <div className="flex flex-col gap-6">
      <div className="flex flex-col gap-1">
        <h1 className="font-display text-h1 font-semibold text-texto">Estadísticas</h1>
        <p className="text-body text-texto-secundario">
          Uso del laboratorio y demanda de reservas. Ningún dato personal
          aparece aquí: para ver quién solicitó una reserva, ve a Solicitudes.
        </p>
      </div>
      ...
      {datos && !sinNadaQueMostrar && (
        <div className="flex flex-col gap-6">
          ...
          <div className="grid grid-cols-2 gap-3 lg:grid-cols-4">
            <StatTile etiqueta="Solicitadas" valor={datos.totales.solicitadas} />
            <StatTile etiqueta="Confirmadas" valor={datos.totales.confirmadas} />
